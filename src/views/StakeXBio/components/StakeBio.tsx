...
const StakeBio: React.FC<StakeProps> = ({}) => {
  const tokenName = "BIO"
  ...
  const tokenBalance = useTokenBalance(contractAddresses.bio[1])
      ...
      <CardContent>
        <StyledCardContentInner>
          <StyledCardHeader>
            ...
            <Label text={`BIO Tokens Available`}/>
          </StyledCardHeader>
          <StyledCardActions>
            {!allowance.toNumber() ? (
              <Button
